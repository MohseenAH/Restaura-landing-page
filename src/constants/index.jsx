...
export const CONTACT = [
  {
    key: "address",
    value: "Address: 123 Main Street, Pune, Maharashtra, India, 411001",
  },
...
export const SOCIAL_MEDIA_LINKS = [
  {
    href: "https://github.com/mohseenah",
    icon: <FaGithub fontSize={30} className="hover:opacity-80" />,
  },
  {
    href: "https://www.linkedin.com/in/mohseenalihawaldar/",
    icon: <FaLinkedin fontSize={30} className="hover:opacity-80" />,
  },
  {
    href: "https://www.youtube.com/@mohseenhawaldar346",
